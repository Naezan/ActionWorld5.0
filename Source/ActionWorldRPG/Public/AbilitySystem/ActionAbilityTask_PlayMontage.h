...
#include "ActionAbilityTask_PlayMontage.generated.h"
 ...
 */
UCLASS()
class ACTIONWORLDRPG_API UActionAbilityTask_PlayMontage : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UActionAbilityTask_PlayMontage(const FObjectInitializer& ObjectInitializer);
	...
	UFUNCTION(BlueprintCallable, Category = "Ability", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
		static UActionAbilityTask_PlayMontage* PlayMontageAndWaitForEvent(
...
private:
	...
	UActionAbilitySystemComponent* GetTargetASC();
