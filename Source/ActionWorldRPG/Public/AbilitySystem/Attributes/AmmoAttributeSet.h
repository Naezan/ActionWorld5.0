 ...
 */
UCLASS()
class ACTIONWORLDRPG_API UAmmoAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(UAmmoAttributeSet, RocketReserveAmmo)
	...
	ATTRIBUTE_ACCESSORS(UAmmoAttributeSet, MaxRocketReserveAmmo)
	...
	ATTRIBUTE_ACCESSORS(UAmmoAttributeSet, ShotgunReserveAmmo)
