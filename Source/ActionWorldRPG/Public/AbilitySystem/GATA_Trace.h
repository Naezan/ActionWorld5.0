 ...
 */
UCLASS()
class ACTIONWORLDRPG_API AGATA_Trace : public AGameplayAbilityTargetActor
{
	GENERATED_BODY()
...
protected:
	...
	virtual void ShowDebugTrace(TArray<FHitResult>&HitResults, EDrawDebugTrace::Type DrawDebugType, float Duration = 2.0f) PURE_VIRTUAL(AGATA_Trace, return;);
