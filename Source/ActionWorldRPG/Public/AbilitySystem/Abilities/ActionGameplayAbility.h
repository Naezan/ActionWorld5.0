...
USTRUCT()
struct ACTIONWORLDRPG_API FAbilityMeshMontage
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class ACTIONWORLDRPG_API UActionGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Ability")
		EActionAbilityInputID AbilityID = EActionAbilityInputID::None;
