...
*/
USTRUCT()
struct ACTIONWORLDRPG_API FGameplayAbilityLocalAnimMontageForMesh
{
	GENERATED_BODY();
...
*/
USTRUCT()
struct ACTIONWORLDRPG_API FGameplayAbilityRepAnimMontageForMesh
{
	GENERATED_BODY();
 ...
 */
UCLASS()
class ACTIONWORLDRPG_API UActionAbilitySystemComponent : public UAbilitySystemComponent
{
	GENERATED_BODY()
...
public:
	...
	static UActionAbilitySystemComponent* GetAbilitySystemComponentFromActor(const AActor* Actor, bool LookForComponent = false);
