...
float AGATA_Trace::GetCurrentSpread() const
{
...
void AGATA_Trace::SetStartLocation(const FGameplayAbilityTargetingLocationInfo& InStartLocation)
{
	StartLocation = InStartLocation;
}

void AGATA_Trace::SetShouldProduceTargetDataOnServer(bool bInShouldProduceTargetDataOnServer)
{
	ShouldProduceTargetDataOnServer = bInShouldProduceTargetDataOnServer;
}

void AGATA_Trace::SetDestroyOnConfirmation(bool bInDestroyOnConfirmation)
{
...
void AGATA_Trace::CancelTargeting()
{
...
void AGATA_Trace::StopTargeting()
{
	SetActorTickEnabled(false);
...
FGameplayAbilityTargetDataHandle AGATA_Trace::MakeTargetData(const TArray<FHitResult>& HitResults) const
{
...
TArray<FHitResult> AGATA_Trace::PerformTrace(AActor* InSourceActor)
{
...
AGameplayAbilityWorldReticle* AGATA_Trace::SpawnReticleActor(FVector Location, FRotator Rotation)
{
	if (ReticleClass)
	{
...
void AGATA_Trace::DestroyReticleActors()
{
